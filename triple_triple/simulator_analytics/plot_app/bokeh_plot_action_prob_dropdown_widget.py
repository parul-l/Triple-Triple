...
# This method has an issue if the first region does not have non zero values for all three actions. I need to open a git issue for this. It does not line up to the proper totals

# Used this as a template
# https://stackoverflow.com/questions/33465827/bokeh-python-use-callback-on-columndatasource-to-change-stacked-bar-chart-with
