...
def get_initial_shooting_sides(df_play_by_play, df_pos_dist, hometeam_id, awayteam_id, has_ball_dist=2):
    ...
    df_pos_dist_trunc =   df_pos_dist[(df_pos_dist.min_dist<has_ball_dist).any(axis=1)].reset_index()
    ...
    first_score = df_pos_dist_trunc[(df_pos_dist_trunc.closest_player.values.flatten()==first_score_player)&
...
if __name__=='__main__':
    ...
    shooting_side = team_shooting_side(player, period, initial_shooting_side, hometeam_id, awayteam_id)  
